...
public class Conserje extends Persona{
    ...
    public Conserje(String carrera, Date fecha_ingreso, int años_servicio, String turno, String cedula, String Nombre, String Apellido, Date fecha_de_nacimiento) {
    ...
    @Override
    public ArrayList ingresar(Object c) {
      listPersona.add((Persona) c);
        return listPersona;
    }
